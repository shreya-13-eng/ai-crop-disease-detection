...
public class SignUpService {
    ...
    public SignUpService(PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager, JwtUtils jwtUtils, UserRepository userRepository, EmailService emailService, UserDetailService userDetailService, EmailService emailService1, UserDetailService userDetailService1) {
